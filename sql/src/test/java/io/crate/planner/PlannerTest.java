...
public class PlannerTest extends CrateUnitTest {
    ...
    @Test
    public void testCrossJoinPlan() throws Exception {
        Plan nestedLoopPLan = plan("select users.name, characters.name from users, characters where users.name='Trillian' order by characters.name");
        int i=0;
    }
}
