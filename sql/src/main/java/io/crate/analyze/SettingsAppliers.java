...
public class SettingsAppliers {
    ...
    public static class DynamicObjectSettingsApplier extends ObjectSettingsApplier {

        protected final NestedSetting setting;

        public DynamicObjectSettingsApplier(NestedSetting setting) {
            super(setting);
            this.setting = setting;
        }

        public NestedSetting setting() {
            return setting;
        }
    }

    public static class StringWithDynamicParentSettingsApplier extends DynamicObjectSettingsApplier {

        private final String childName;

        public StringWithDynamicParentSettingsApplier(NestedSetting setting, String childName) {
            super(setting);
